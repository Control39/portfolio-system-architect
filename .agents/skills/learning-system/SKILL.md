...
python -m agents.learning --full-cycle --data-dir=.agents/data/ --output=learning_report.json
...
python -m agents.learning.patterns --data-dir=.agents/data/historical/ --min-confidence=0.8
...
1. Создайте класс метрики в `.agents/learning/metrics/`
...
python -m agents.learning.analyze_data --data-dir=.agents/data/ --quality-report
