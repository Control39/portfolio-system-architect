...
from apps.knowledge_graph.src.api.main import app, entities_db, relationships_db
...
class TestEntityCRUD:
    ...
    def test_get_entity(self):
        ...
        client.post(
            "/entities",
            json={"entity_id": "user-002", "entity_type": "person", "properties": {"name": "Bob"}},
        )
        # Получаем
    ...
    def test_duplicate_entity_id(self):
        entity_data = {"entity_id": "user-005", "entity_type": "person", "properties": {}}
...
class TestEdgeCases:
    ...
    def test_empty_properties(self):
        entity_data = {"entity_id": "user-empty", "entity_type": "person", "properties": {}}
        response = client.post("/entities", json=entity_data)
        assert response.status_code == 200
