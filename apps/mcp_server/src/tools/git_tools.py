...
def init_git_tools(mcp_server: FastMCP, project_root: Path) -> None:
    """Инициализация инструментов Git"""
    global PROJECT_ROOT
    ...
    def get_git_status_tool() -> dict[str, Any]:
        ...
        """
        try:
            root = PROJECT_ROOT or Path(__file__).parent.parent.parent.parent
            ...
            commit_count_result = subprocess.run(  # nosec B603, B607
    ...
    def scan_last_commits_for_markers_tool(commits_count: int = 10) -> dict[str, Any]:
        ...
        try:
            ...
            markers_path = root / "apps" / "it-compass" / "src" / "data" / "markers"
