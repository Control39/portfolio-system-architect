...
Model Context Protocol implementation server
...
```bash
python -m pytest tests/test_integration_mcp_server.py -v
```
...
│   └── test_integration_mcp_server.py  # Integration tests (if applicable)
...
## ⚙️ Тип и Назначение
**Тип:** MCP Server
**Назначение:** Model Context Protocol.
**Интерфейс:** Events.
