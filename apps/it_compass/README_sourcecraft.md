...
### Проблема, которую решает IT-Compass

Оценка компетенций в IT традиционно субъективна и фрагментирована:
- **HR-разрыв:** Рекрутеры не понимают технической глубины кандидатов.
- **Отсутствие метрик:** Разработчики не видят своего прогресса в освоении технологий.
...
IT-Compass предлагает **объективную методологию измерения компетенций**:
- **83 маркера в 19 доменах:** От разработки (Python, JavaScript) до DevOps, безопасности и архитектуры.
- **Уровни сложности:** Junior → Middle → Senior с чёткими критериями перехода.
- **Сбор доказательств:** Привязка маркеров к реальным проектам и коду.
- **Рекомендации:** Персональные планы развития на основе анализа пробелов.

### Преимущества архитектуры

| Без IT-Compass | С IT-Compass |
|----------------|--------------|
| Субъективная оценка на собеседовании | Объективные метрики по 83 маркерам |
| Нет видимости прогресса | Визуализация роста по доменам |
| Фрагментированное резюме | Единая карта компетенций |
| Риск выгорания | Профилактика через видимость прогресса |

### Готовая формулировка для портфолио

> **«Методология объективного измерения компетенций (IT-Compass)»**<br>
> Разработана фреймворк для объективной оценки технических компетенций через 83 проверочных маркера в 19 IT-доменах. Система позволяет отслеживать прогресс от Junior до Senior уровня, привязывая маркеры к реальным проектам и коду. Внедрена система рекомендаций для карьерного развития и профилактика выгорания через визуализацию достижений. Используется как инструмент оценки для HR и технический лидов, а также как персональный трекер роста для разработчиков.
