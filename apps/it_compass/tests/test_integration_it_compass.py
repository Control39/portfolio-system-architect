"""
Integration Tests for it_compass
...
def test_compass_reasoning_integration(service_instance, mock_dependencies, service_config):
    ...
    Validates integration between it_compass and its dependencies.
    """
    # Arrange
...
def test_compass_complex_scenarios(service_instance, mock_dependencies, service_config):
    """
    Test Case 4: Compass Complex Scenarios
...
def test_compass_performance(service_instance, mock_dependencies, service_config):
    """
    Test Case 5: Compass Performance
