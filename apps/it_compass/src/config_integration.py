"""
Интеграция с AI Config Manager для It Compass
...
class ItCompassConfig:
    """Обёртка для конфигурации It Compass через AI Config Manager"""
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        if self._config_manager:
            try:
                return self._config_manager.get_agent_config("it_compass")
            except Exception:
...
def get_config() -> ItCompassConfig:
    ...
    if _config_instance is None:
        _config_instance = ItCompassConfig()
