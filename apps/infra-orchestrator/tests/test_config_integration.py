...
class Testinfra_orchestratorConfigIntegration:
    ...
    def test_config_integration_module(self):
        ...
        from apps.infra_orchestrator.src import config_integration
        assert hasattr(config_integration, "infra_orchestratorConfig")
    ...
    def test_reload_config(self):
        ...
        from apps.infra_orchestrator.src.config_integration import reload_config
        # Should not raise
        reload_config()
