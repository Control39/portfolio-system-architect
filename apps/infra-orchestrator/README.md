...
Infrastructure orchestration and management service
...
```bash
python -m pytest tests/test_integration_infra_orchestrator.py -v
```
...
│   └── test_integration_infra_orchestrator.py  # Integration tests (if applicable)
...
## ⚙️ Тип и Назначение
**Тип:** Library
**Назначение:** Infrastructure utilities.
