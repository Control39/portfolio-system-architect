...
Task automation and job scheduling agent
...
```bash
python -m pytest tests/test_integration_job_automation_agent.py -v
```
...
│   └── test_integration_job_automation_agent.py  # Integration tests (if applicable)
