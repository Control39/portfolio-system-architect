...
```bash
python -m pytest tests/test_integration_competency_gap_engine.py -v
```
...
│   └── test_integration_competency_gap_engine.py  # Integration tests (if applicable)
