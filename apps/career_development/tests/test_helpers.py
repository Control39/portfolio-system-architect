...
from apps.career_development.utils.helpers import (
    calculate_skill_progress, convert_bytes_to_human_readable,
    create_directory_if_not_exists, format_date, get_competency_level_name,
    get_file_size, load_json_file, sanitize_filename, save_json_file,
    validate_email)
...
class TestHelpers(unittest.TestCase):
    def test_validate_email(self):
        ...
        # Функция validate_email не определена,
        # используем validate_evidence_link как ближайший аналог
