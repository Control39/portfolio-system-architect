"""
Enhanced Tests for template-service
...
class TestBasicFunctionality:
    ...
    def test_template_rendering(self, service_instance, config, mock_logger):
        """
    ...
    def test_template_with_variables(self, service_instance, config, mock_logger):
        """
    ...
    def test_template_error_handling(self, service_instance, config, mock_logger):
        """
