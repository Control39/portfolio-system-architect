...
def service_instance(service_config, mock_dependencies):
    ...
    # from apps.mcp-server.src import Service
...
def test_mcp_protocol_compliance(service_instance, mock_dependencies, service_config):
    ...
    assert service_config["name"] == "mcp-server"
...
@pytest.mark.asyncio
async def test_mcp_protocol_compliance_async(service_instance, mock_dependencies):
    """Async version of test_mcp_protocol_compliance"""
    # Arrange
...
@pytest.mark.asyncio
async def test_mcp_agent_integration_async(service_instance, mock_dependencies):
    """Async version of test_mcp_agent_integration"""
    # Arrange
    service_instance.initialize = MagicMock(return_value=True)
...
@pytest.mark.asyncio
async def test_mcp_concurrent_connections_async(service_instance, mock_dependencies):
    """Async version of test_mcp_concurrent_connections"""
    # Arrange
    service_instance.initialize = MagicMock(return_value=True)
...
@pytest.mark.asyncio
async def test_mcp_error_handling_async(service_instance, mock_dependencies):
    """Async version of test_mcp_error_handling"""
    # Arrange
    service_instance.initialize = MagicMock(return_value=True)
...
@pytest.mark.asyncio
async def test_mcp_resource_management_async(service_instance, mock_dependencies):
    """Async version of test_mcp_resource_management"""
    # Arrange
    service_instance.initialize = MagicMock(return_value=True)
