...
```bash
python -m pytest tests/test_integration_ai_provider_manager.py -v
```
...
│   └── test_integration_ai_provider_manager.py  # Integration tests (if applicable)
