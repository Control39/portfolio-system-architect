"""
Тесты интеграции с AI Config Manager для Ml Model Registry
"""
...
class TestMlModelRegistryConfigIntegration:
    """Тесты интеграции конфигурации Ml Model Registry"""
    ...
    def test_config_integration_module(self):
        ...
        sys.path.insert(0, str(REPO_ROOT / "apps" / "ml_model_registry" / "src"))
        from config_integration import MlModelRegistryConfig

        assert MlModelRegistryConfig is not None
