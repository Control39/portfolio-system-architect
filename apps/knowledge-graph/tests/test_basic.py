"""
Enhanced Tests for knowledge-graph
...
class TestBasicFunctionality:
    ...
    def test_knowledge_graph_stores_entities(self, service_instance, config, mock_logger):
        """
        Test: Knowledge Graph Stores Entities
        """
        assert service_instance is not None
        assert config["environment"] == "test"
    ...
    def test_knowledge_graph_finds_relationships(self, service_instance, config, mock_logger):
        """
        Test: Knowledge Graph Finds Relationships
        """
        assert service_instance is not None
        assert config["environment"] == "test"
    ...
    def test_knowledge_graph_query_performance(self, service_instance, config, mock_logger):
        """
