...
class Testai_config_managerConfigIntegration:
    ...
    def test_config_integration_module(self):
        ...
        from apps.ai_config_manager.src import config_integration
        assert hasattr(config_integration, "ai_config_managerConfig")

    def test_get_config_singleton(self):
        """Test get_config returns singleton instance"""
        from apps.ai_config_manager.src.config_integration import get_config
        config = get_config()
    ...
    def test_reload_config(self):
        ...
        from apps.ai_config_manager.src.config_integration import reload_config
        # Should not raise
        reload_config()
