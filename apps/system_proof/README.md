...
**Проблема:**  
При масштабировании до 18 сервисов возникли проблемы:
...
**Применение:**  
Валидация 18 сервисов перед деплоем:
- Проверено 18 × 20 = 360 критериев
...
- **ADR:** [ADR-012: System Proof](../../docs/adr/ADR-012-system-proof.md)
