...
REPORTS_DIR = ROOT_DIR / "reports" / "plans"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOGS_DIR / "planner.log"),
...
class TaskPlanner:
    ...
    def prioritize_tasks(self) -> list[dict[str, Any]]:
        ...
        for task in self.tasks:
            ...
            dependencies_factor = 0.7 if task.get("dependencies") else 1.0
    ...
    def optimize_schedule(self) -> dict[str, Any]:
        ...
        planning_horizon = self.config.get("planning", {}).get("planning_horizon", 24)
        ...
        for task in self.tasks:
            ...
            slot_found = False
            for minute_offset in range(0, planning_horizon * 60, 30):
                check_time = current_time + timedelta(minutes=minute_offset)
    ...
    def group_parallel_tasks(self) -> dict[str, list[dict[str, Any]]]:
        ...
        for category, data in groups.items():
            ...
            if tasks:
                ...
                data["avg_priority"] = avg_priority
...
def main():
    ...
    try:
        ...
        status_file = PLANS_DIR / "last_plan_status.json"
