...
FILE_MAP = [
    ...
    ("docs/architecture/decisions/ADR-010-diagram-format.md", 4, "Diagram format (Mermaid) — was ADR-010"),
    ...
    ("docs/architecture/decisions/ADR-007-technology-stack-justification.md", 9, "Stack justification"),
    ...
    ("docs/architecture/decisions/ADR-015-monorepo-boundary.md", 14, "src/ vs apps/ boundary — was ADR-015"),
    ("docs/architecture/decisions/ADR-016-standardize-documentation.md", 15, "Documentation standard — was ADR-016"),
    ("docs/architecture/decisions/ADR-017-mcp-server-coverage-decision.md", 16, "MCP Server coverage — was ADR-017"),
    ("docs/architecture/decisions/ADR-018-dependency-injection.md", 17, "Dependency injection — was ADR-018"),
    ("docs/architecture/decisions/ADR-018-documentation-and-audit-standards.md", 18, "Documentation & audit — was ADR-018"),
