...
THEME_MAPPING = {
    "apps": (
        ...
        [
            ...
            "apps/infra_orchestrator",
            "apps/ai_config_manager",
            "apps/knowledge_graph",
            "apps/mcp_server",
            "apps/template_service",
            "apps/job_automation_agent",
            "apps/thought_architecture",
        ],
    ),
    "docs-methodology": (
        "🎓 Методология it_compass",
        [
            "docs/methodology",
    ...
    priority_themes = [
        ...
        (
            ...
            [
                ...
                "docs/methodology/02_METHODOLOGY/it_compass",
                "docs/methodology/02_METHODOLOGY",
        ...
        (
            "🚀 Деплой и Kubernetes",
            ["deployment/secrets", "deployment/k8s", "deployment/gitops", "deployment"],
        ),
        ...
        (
            "🔧 DevOps и Инструменты",
            ["scripts/dev", "scripts", "tools", "monitoring", "docker/base-images", "docker"],
        ),
