...
CATEGORIES = {
    "CI / CD": ["ci.yml", "deploy.yml", "deploy-k8s.yml", "deploy-pages.yml",
                "deploy-dashboard.yml", "azure-deploy.yml", "release.yml",
                "code-quality.yml", "security-scan.yml", "codeql.yml",
                "cognitive-agent-ci.yml", "test-decision-engine.yml"],
    "Monitoring & Alerts": ["monitoring-alerts.yml", "mirror-sync-enhanced.yml",
                            "mirror-to-sourcecraft.yml", "monitor-mirror-discrepancies.yml",
    ...
    "Utilities": ["repo-audit.yml", "architecture-analysis.yml",
                  "duplicate-check.yml", "vscode-extensions-check.yml"],
