...
def main():
    ...
    parser.add_argument("--description", type=str, default="Новый сервис", help="Описание сервиса")
    parser.add_argument(
        "--add-compose",
        action="store_true",
        dest="add_compose",
    ...
    print("2. Отредактируйте main.py — добавьте бизнес-логику")
    print("3. Отредактируйте README.md — добавьте детали")
    print("4. python -m pytest — запустите тесты")
