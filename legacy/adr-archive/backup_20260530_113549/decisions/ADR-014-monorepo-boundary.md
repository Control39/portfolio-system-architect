> **Former ID:** ADR-015-monorepo-boundary
> **Former path:** `docs\architecture\decisions\ADR-015-monorepo-boundary.md`
> **Current ID:** ADR-014
...
- [ADR-011: Базовые Docker-образы](ADR-011-base-docker-images.md) — `docker/base-images/` используются apps/
