...
# Новая структура
NEW_STRUCTURE = {
    "integration": ["case-1-it-compass-portfolio-organizer", "case-2-infra-orchestrator-decision-engine", "case-3-system-proof-thought-architecture"],
...
def main():
    ...
    if infra_sync.exists():
        ...
        print(f"✅ infra-sync-hardening-2026.md → technical/")
