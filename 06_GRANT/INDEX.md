# Грантовые материалы (Grant Materials Index)

## 🚀 Быстрый доступ

| Документ | Описание | Ссылка |
|----------|----------|--------|
| **Executive Summary** | Краткий обзор (RU/EN, 350 слов) | [EXECUTIVE_SUMMARY.md](EXECUTIVE_SUMMARY.md) |
...
2. [ ] Demo: `docker compose up -d`
3. [ ] Видео: 90s demo (TBA)
