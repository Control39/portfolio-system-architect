...
## ⚠️ ВАЖНОЕ ПРЕДУПРЕЖДЕНИЕ ДЛЯ AI-АГЕНТА
...
**Ваша документация защищает репозиторий от ошибок агента!**
- ✅ Всегда документируйте скрипты, которые изменяют файлы
- ✅ Описывайте, **что именно** и **каким образом** будет изменено
- ✅ Проверяйте статичные значения - не устарели ли они?
