...
> - **Бизнес-роль** (ниже) — для понимания ценности и назначения
> - **Техническая структура** — см. [`apps/README.md`](apps/) с автоматической классификацией
> - 📊 **Демо работы сканера:** [classifier-demo-output.txt](docs/reports/classifier-demo-output.txt)
