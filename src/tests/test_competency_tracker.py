...
class TestCompetencyTracker(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tracker.add_competency_marker("marker_001", "Основы программирования", "Понимание базовых концепций программирования", 2)
        self.tracker.add_competency_marker("marker_002", "Продвинутые алгоритмы", "Знание сложных алгоритмов и структур данных", 4)
    ...
    def test_add_competency_marker(self):
        ...
        self.assertEqual(self.tracker.competency_markers["marker_001"]['title'], "Основы программирования")
