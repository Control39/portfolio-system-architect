...
class ServiceDiscovery:
    ...
    PYTHON_FRAMEWORK_PATTERNS: dict[str, list[str]] = {
        ...
        "flask": [r"from flask", r"import flask", r"Flask\(", r"@app\.route", r"@app\.errorhandler", r"request\."],
        "django": [
            r"from django",
            r"import django",
            r"django\.setup\(",
    ...
    CRITICALITY_INDICATORS = {
        "critical": ["cognitive_agent", "decision_engine", "it_compass", "auth_service", "payment"]
    }
