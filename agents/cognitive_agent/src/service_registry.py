...
class ServiceProfile:
    ...
    framework: str | None = None  # 'fastapi', 'flask', 'django', 'spring-boot' etc.
...
class ServiceDiscovery:
    ...
    PYTHON_FRAMEWORK_PATTERNS = {
        ...
        "django": [r"from django", r"import django", r"django\.setup\(", r"class.*\(models\.Model\)"],
    }
    ...
    @classmethod
    def detect_framework(cls, service_path: str, language: str = "python") -> str | None:
...
class ServiceRegistry:
    ...
    def get_profile_by_path(self, file_path: str) -> ServiceProfile | None:
        """
    ...
    def get_high_priority_profiles(self) -> list[ServiceProfile]:
        ...
        return [p for p in self.profiles.values() if p.is_active and p.criticality in ["high", "critical"]]
