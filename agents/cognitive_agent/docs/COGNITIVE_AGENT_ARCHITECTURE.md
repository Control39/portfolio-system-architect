...
### **Молекулы (agents/cognitive_agent/)**
...
```python
# agents/cognitive_agent/src/api/endpoints.py
...
| **FastAPI сервер**      | `agents/cognitive_agent/src/`     | Конкретный сервис              |
| **API эндпоинты**       | `agents/cognitive_agent/src/api/` | Конкретный сервис              |
| **Скрипты агента**      | `agents/cognitive_agent/scripts/` | Бизнес-логика сервиса          |
