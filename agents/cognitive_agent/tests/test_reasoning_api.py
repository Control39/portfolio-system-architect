...
def create_all_mocks():
    ...
    yandexcloud_mock.cloud.ai.foundation_models.v1.text_generation.text_generation_service_pb2_grpc = (
        text_generation_service_pb2_grpc_mock
    )
    ...
    return (
        yandexcloud_mock,
        text_common_pb2_mock,
        text_generation_service_pb2_grpc_mock,
        portfolio_logger_mock,
        portfolio_logger_instance,
    )
