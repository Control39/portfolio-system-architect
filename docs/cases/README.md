...
- [Для HR](ai-config-manager/FOR_HR.md)

**Ключевые технологии:** Electron, WebSocket, React Native, Ollama, GigaChat, YandexGPT
**Результат:** 5+ интегрированных AI, real-time мониторинг, автоматическая генерация конфигов
